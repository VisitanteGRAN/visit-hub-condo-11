...
# -*- coding: utf-8 -*-
"""
WINDOWS POLLING SERVICE - VERSÃO SIMPLES E ROBUSTA
=================================================
"""
...
def check_queue():
    ...
    try:
        ...
        # Buscar itens pendentes diretamente na tabela
...
def process_visitor(queue_item):
    ...
    try:
        ...
        # Executar script HikCentral MELHORADO
        script_path = 'test_hikcentral_improved_windows.py'
        cmd = [
            'python',
            script_path,
            '--visitor-data', temp_file,
            '--visitor-id', item_id
            # Sem --headless para ver o processo
        ]
...
def main():
    """Loop principal"""
    print("WINDOWS POLLING SERVICE - VERSAO SIMPLES")
    print("=" * 50)
