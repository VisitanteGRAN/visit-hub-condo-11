              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-center pt-4">
                  <Button 
                    ...
                    className="w-full md:w-auto px-8 py-3 bg-primary hover:bg-primary/90 text-primary-foreground font-medium hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
                    disabled={isGenerating}
                  >
                    {isGenerating ? (
                      <>
                        <svg className="animate-spin h-4 w-4 mr-2 text-primary-foreground" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
